...
<div class="container mt-5">
    <div class="page-header">
        <h2><i class="fas fa-edit me-2"></i>Shop 수정</h2>
    </div>
                ...
                <div class="card-body p-4">
                    <form method="post" action="/shop/edit">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="<%= shop.getName() %>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-map-marker-alt me-1"></i> 주소</label>
                            <input type="text" name="address" class="form-control" value="<%= shop.getAddress() %>" required>
                        </div>
